			...
			<div className='container'>
				...
				<div className='relative'>
					<div className='relative z-1 flex items-center h-[39rem] p-8 mb-5 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
						...
						<div className='relative z-1 max-w-[17rem] ml-auto'>
							...
							<ul className='body-2'>
								{brainwaveServices.map((item, index) => (
									<li
										className='flex items-start py-4 border-top border-n-6'
										key={index}
									>
						...
						<Generating className='absolute right-4 bottom-4 left-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg-translate-x-1/2' />
					</div>
